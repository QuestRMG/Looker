...
- explore: customer_bak
  joins:
    - join: customer_profile
      type: left_outer 
      sql_on: ${customer_bak.customer_profile_id} = ${customer_profile.id}
      relationship: many_to_one

    - join: customer_segment
      type: left_outer 
      sql_on: ${customer_bak.customer_segment_id} = ${customer_segment.id}
      relationship: many_to_one
...
- explore: excel_auto_load

- explore: excel_file_header

- explore: excel_header_name
...
- explore: file_import_log_bak
  joins:
    - join: customer_profile
      type: left_outer 
      sql_on: ${file_import_log_bak.customer_profile_id} = ${customer_profile.id}
      relationship: many_to_one

    - join: data_source
      type: left_outer 
      sql_on: ${file_import_log_bak.data_source_id} = ${data_source.id}
      relationship: many_to_one


- explore: file_import_log_bak0925
  joins:
    - join: customer_profile
      type: left_outer 
      sql_on: ${file_import_log_bak0925.customer_profile_id} = ${customer_profile.id}
      relationship: many_to_one

    - join: data_source
      type: left_outer 
      sql_on: ${file_import_log_bak0925.data_source_id} = ${data_source.id}
      relationship: many_to_one
...
- explore: recycle_center_bak

- explore: recycle_center_bkupda

- explore: recycle_center_denise
